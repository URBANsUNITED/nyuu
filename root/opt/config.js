...
servers: [
	{
		...
		connect: { // connection options
			host: '',
			port: 80, // null => if server.secure, port=563, else, port=119
		...
		postConnections: 2, // number of connections for posting
		checkConnections: 2, // number of connections used for checking
...
obfuscateArticles: false, // if true, yenc header filename will be a randomized 32-62 hex string
